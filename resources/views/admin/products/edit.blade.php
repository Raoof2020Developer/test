...
<div class="content">
    <form class="mb-9" action="{{route('products.update', $product)}}" method="POST" enctype="multipart/form-data">
        @method('PATCH')
      @csrf
      <div class="row g-3 flex-between-end mb-5">
        <div class="col-auto">
          <h2 class="mb-2">Edit the product</h2>
          <h5 class="text-700 fw-semi-bold">Orders placed across your store</h5>
        </div>
        <div class="col-auto">
          <button class="btn btn-primary mb-2 mb-sm-0" type="submit">Edit product</button>
        </div>
      </div>
      <div class="row g-5">
        <div class="col-12 col-xl-8">
          <h4 class="mb-3">Product Name</h4>
          <input class="form-control mb-5" type="text" name="name" placeholder="Write title here..." value="{{$product->name}}"/>
          @error('name')
                ...
                <div class="tab-pane fade show active" id="pricingTabContent" role="tabpanel">
                  ...
                  <div class="row g-3">
                    <div class="col-12 col-lg-6">
                      ...
                      <input class="form-control" name="gram_buying_price" type="decimal" placeholder="$$$" value="{{$product->gram_buying_price}}"/>
                    ...
                    <div class="col-12 col-lg-6">
                      ...
                      <input class="form-control" name="gram_selling_price" type="decimal" placeholder="$$$" value="{{$product->gram_selling_price}}"/>
                    ...
                    <div class="col-12 col-lg-6">
                      ...
                      <input class="form-control" name="max_discount" type="decimal" placeholder="$$$" value="{{$product->max_discount}}"/>
                      @error('max_discount')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
                ...
                <div class="tab-pane fade h-100" id="restockTabContent" role="tabpanel" aria-labelledby="restockTab">
                  <div class="d-flex flex-column h-100">
                    ...
                    <div class="row g-3 flex-1 mb-4">
                      <div class="col-sm-7">
                        <input class="form-control" name="quantity" type="number" placeholder="Quantity" value="{{$product->quantity}}"/>
                        @error('quantity')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{$message}}</strong>
                          </span>
                ...
                <div class="tab-pane fade" id="advancedTabContent" role="tabpanel" aria-labelledby="advancedTab">
                  ...
                  <div class="row g-3">
                    <div class="col-12 col-lg-6">
                      ...
                      <input class="form-control" type="text" name="ref" placeholder="ISBN Number" value="{{$product->ref}}"/>
                      @error('ref')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
                    ...
                    <div class="col-12 col-lg-6">
                      ...
                      <input class="form-control" type="text" name="designation" placeholder="ISBN Number" value="{{$product->designation}}"/>
                      @error('designation')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
                    ...
                    <div class="col-12 col-lg-6">
                      ...
                      <input class="form-control" type="decimal" name="gram_weight" placeholder="ISBN Number" value="{{$product->gram_weight}}"/>
                      @error('gram_weight')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
