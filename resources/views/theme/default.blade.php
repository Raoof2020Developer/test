...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{!! asset('theme/img/favicons/apple-touch-icon.png') !!}">
    ...
    <meta name="msapplication-TileImage" content="{!! asset('theme/img/favicons/mstile-150x150.png') !!}">
    <meta name="theme-color" content="#ffffff">
    <script src="{!! asset('theme/vendors/imagesloaded/imagesloaded.pkgd.min.js') !!}"></script>
    ...
    <link href="{!! asset('theme/css/theme-rtl.min.css') !!}" type="text/css" rel="stylesheet" id="style-rtl">
    <link href="{!! asset('theme/css/theme.min.css') !!}" type="text/css" rel="stylesheet" id="style-default">
    <link href="{!! asset('theme/css/user-rtl.min.css') !!}" type="text/css" rel="stylesheet" id="user-style-rtl">
    ...
    <link href="{!! asset('theme/vendors/leaflet/leaflet.css') !!}" rel="stylesheet">
    <link href="{!! asset('theme/vendors/leaflet.markercluster/MarkerCluster.css') !!}" rel="stylesheet">
    <link href="{!! asset('theme/vendors/leaflet.markercluster/MarkerCluster.Default.css') !!}" rel="stylesheet">
    <link href="{!! asset('theme/vendors/simplebar/simplebar.min.css') !!}" rel="stylesheet">
    <link href="{!! asset('theme/vendors/choices/choices.min.css') !!}" rel="stylesheet">
    <link href="{!! asset('theme/vendors/flatpickr.min.css') !!}" rel="stylesheet">
  ...
  <body>
    ...
    <script src="{!! asset('theme/vendors/leaflet/leaflet.js') !!}"></script>
    <script src="{!! asset('theme/vendors/leaflet.markercluster/leaflet.markercluster.js') !!}"></script>
    <script src="{!! asset('theme/vendors/leaflet.tilelayer.colorfilter/leaflet-tilelayer-colorfilter.min.js') !!}"></script>
    <script src="{!! asset('theme/vendors/choices/choices.min.js') !!}"></script>

    <script src="{!! asset('theme/js/ecommerce-dashboard.js') !!}"></script>
